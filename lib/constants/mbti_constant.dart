...
class MbtiConstant {
  ...
  static const String INTP = 'INTP';
  static const String ENTJ = 'ENTJ';
  static const String ENTP = 'ENTP';
  static const String INFJ = 'INFJ';
  static const String INFP = 'INFP';
  static const String ENFJ = 'ENFJ';
  static const String ENFP = 'ENFP';
  static const String ISTJ = 'ISTJ';
  static const String ISFJ = 'ISFJ';
  static const String ESTJ = 'ESTJ';
  static const String ESFJ = 'ESFJ';
  static const String ISTP = 'ISTP';
  static const String ISFP = 'ISFP';
  static const String ESTP = 'ESTP';
  static const String ESFP = 'ESFP';
  ...
  static const Map<String, String> descriptions = {
    'INTJ': '건축가 - 모든 일에 대한 계획을 가진 상상력 있고 전략적인 사고가 뛰어난 사람들.',
    'INTP': '논리학자 - 지식에 대한 끝없는 갈증을 가진 혁신적인 발명가.',
    'ENTJ': '지휘관 - 대담하고 상상력이 풍부하며 강한 의지를 가진 지도자, 항상 방법을 찾거나 만들어내는 사람들.',
    'ENTP': '토론자 - 지적 도전을 거부할 수 없는 똑똑하고 호기심 많은 사고가.',
    'INFJ': '옹호자 - 조용하고 신비롭지만 매우 영감을 주며 끈기 있는 이상주의자.',
    'INFP': '중재자 - 시적이고 친절하며 이타적인 사람들, 항상 좋은 원인을 돕고 싶어하는 사람들.',
    'ENFJ': '주인공 - 카리스마 있고 영감을 주는 지도자, 청중을 매료시킬 수 있는 사람들.',
    'ENFP': '활동가 - 열정적이고 창의적이며 사교적인 자유로운 영혼, 항상 웃을 이유를 찾는 사람들.',
    'ISTJ': '현실주의자 - 실용적이고 사실에 중점을 둔 신뢰할 수 있는 사람들.',
    'ISFJ': '수호자 - 매우 헌신적이고 따뜻한 보호자, 항상 사랑하는 사람들을 지킬 준비가 된 사람들.',
    'ESTJ': '경영자 - 뛰어난 관리자, 사물이나 사람을 관리하는 데 탁월한 사람들.',
    'ESFJ': '집정관 - 매우 자상하고 사교적이며 인기 있는 사람들, 항상 돕고 싶어하는 사람들.',
    'ISTP': '장인 - 대담하고 실용적인 실험가, 모든 종류의 도구에 능숙한 사람들.',
    'ISFP': '모험가 - 유연하고 매력적인 예술가, 항상 새로운 것을 탐험하고 경험할 준비가 된 사람들.',
    'ESTP': '기업가 - 똑똑하고 활기차며 매우 예리한 사람들, 항상 극한의 삶을 즐기는 사람들.',
    'ESFP': '연예인 - 자발적이고 활기차며 열정적인 사람들, 그들 주변은 결코 지루하지 않은 사람들.',
  };
}
